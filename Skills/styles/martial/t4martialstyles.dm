/obj/Skills/Buffs/NuStyle/UnarmedStyle
	...
	Ten_Directions
		...
		"BladeFisting" = 1, "NeedsSword" = 0, "NoSword" = 1, "Interception" = 3, "Sunyata" = 3, "LikeWater" = 5, "Soft Style" = 1,"Flow" = 4, "Godspeed" = 3, "Skimming" = 2)
	...
	High_Roller// mystic+unarmed
		...
		adjust(mob/p)
			passives = list("HybridStyle" = "MysticStyle","Fury" = 4, "Momentum" = 4,  "Hardening" = 2, "SpiritHand" = 4, "Instinct" = 2, \
							"Flow" = 2, "SpiritFlow" = 2, "Combustion" = 50, "Scorching" = 6, "Shattering" = 5, "Hard Style" = 1)
